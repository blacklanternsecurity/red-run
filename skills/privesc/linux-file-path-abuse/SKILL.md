...
- NFS exploitation: `$RED_RUN_DOCS/hacktricks/linux-hardening/privilege-escalation/nfs-no_root_squash-misconfiguration-pe.md`
- Library hijacking: `$RED_RUN_DOCS/hacktricks/linux-hardening/privilege-escalation/ld.so.conf-example.md`
- Docker/LXD groups: `$RED_RUN_DOCS/hacktricks/linux-hardening/privilege-escalation/interesting-groups-linux-pe/`
- Writable file exploitation: `$RED_RUN_DOCS/hacktricks/linux-hardening/privilege-escalation/write-to-root.md`
- InternalAllTheThings NFS: `$RED_RUN_DOCS/InternalAllTheThings/docs/redteam/escalation/linux/`
