...
```
Read ~/docs/hacktricks/src/windows-hardening/windows-local-privilege-escalation/dll-hijacking/README.md
Read ~/docs/hacktricks/src/windows-hardening/windows-local-privilege-escalation/dll-hijacking/writable-sys-path-dll-hijacking-privesc.md
Read ~/docs/hacktricks/src/windows-hardening/windows-local-privilege-escalation/service-triggers.md
Read ~/docs/hacktricks/src/windows-hardening/windows-local-privilege-escalation/abusing-auto-updaters-and-ipc.md
