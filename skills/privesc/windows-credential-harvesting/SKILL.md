...
```
Read ~/docs/hacktricks/src/windows-hardening/windows-local-privilege-escalation/dpapi-extracting-passwords.md
Read ~/docs/hacktricks/src/windows-hardening/stealing-credentials/credentials-mimikatz.md
