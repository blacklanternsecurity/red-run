...
```
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adds-enumerate.md
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adds-groups.md
Read ~/docs/hacktricks/src/windows-hardening/active-directory-methodology/README.md
Read ~/docs/hacktricks/src/windows-hardening/active-directory-methodology/bloodhound.md
```
