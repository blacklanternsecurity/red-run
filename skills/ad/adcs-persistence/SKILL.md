...
```
Read ~/docs/hacktricks/src/windows-hardening/active-directory-methodology/ad-certificates/certificate-theft.md
...
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adcs-esc09.md
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adcs-esc10.md
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adcs-esc13.md
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adcs-esc14.md
Read ~/docs/InternalAllTheThings/docs/active-directory/ad-adcs-esc15.md
```
