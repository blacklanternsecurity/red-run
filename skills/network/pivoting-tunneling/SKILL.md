...
- **Activity** → append to `engagement/activity.md` at milestones:
  `### [HH:MM] pivoting-tunneling → <target_network>` with tunnel type and endpoints.
...
```
Read $RED_RUN_DOCS/hacktricks/src/generic-methodologies-and-resources/tunneling-and-port-forwarding.md
Read $RED_RUN_DOCS/InternalAllTheThings/docs/redteam/pivoting/
Read $RED_RUN_DOCS/hacktricks/src/network-services-pentesting/pentesting-ssh.md
```
