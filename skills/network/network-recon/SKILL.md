...
- **Activity** → append to `engagement/activity.md` at milestones:
  `### [HH:MM] network-recon → <target>` with discovered hosts, open ports, services.
...
```
Read $RED_RUN_DOCS/hacktricks/src/network-services-pentesting/
Read $RED_RUN_DOCS/InternalAllTheThings/docs/redteam/recon/
Read $RED_RUN_DOCS/hacktricks/src/network-services-pentesting/pentesting-smb/
Read $RED_RUN_DOCS/hacktricks/src/network-services-pentesting/pentesting-ldap.md
```
