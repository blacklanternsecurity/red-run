...
```
Read $RED_RUN_DOCS/hacktricks/src/linux-hardening/privilege-escalation/docker-security/docker-breakout-privilege-escalation/README.md
Read $RED_RUN_DOCS/hacktricks/src/linux-hardening/privilege-escalation/docker-security/docker-breakout-privilege-escalation/sensitive-mounts.md
Read $RED_RUN_DOCS/hacktricks/src/linux-hardening/privilege-escalation/docker-security/docker-breakout-privilege-escalation/docker-release_agent-cgroups-escape.md
Read $RED_RUN_DOCS/InternalAllTheThings/docs/containers/docker.md
Read $RED_RUN_DOCS/InternalAllTheThings/docs/containers/kubernetes.md
Read $RED_RUN_DOCS/hacktricks/src/network-services-pentesting/2375-pentesting-docker.md
Read $RED_RUN_DOCS/hacktricks/src/linux-hardening/privilege-escalation/docker-security/namespaces/
```
