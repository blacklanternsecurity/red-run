...
Read ~/docs/hacktricks/src/pentesting-web/deserialization/basic-java-deserialization-objectinputstream-readobject.md
Read ~/docs/hacktricks/src/pentesting-web/deserialization/jndi-java-naming-and-directory-interface-and-log4shell.md
Read ~/docs/hacktricks/src/pentesting-web/deserialization/java-transformers-to-rutime-exec-payload.md
Read ~/docs/hacktricks/src/pentesting-web/deserialization/java-dns-deserialization-and-gadgetprobe.md
```
