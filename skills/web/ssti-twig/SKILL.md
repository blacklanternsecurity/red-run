...
- **Activity** → append to `engagement/activity.md` at milestones (test confirmed,
  ...
  `### [HH:MM] ssti-twig → <target>` with bullet points of actions/results.
...
- **Got RCE**: Establish reverse shell, route to privesc
...
```
Read $RED_RUN_DOCS/PayloadsAllTheThings/Server Side Template Injection/PHP.md
