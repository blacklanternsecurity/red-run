...
See `$RED_RUN_DOCS/PayloadsAllTheThings/Upload Insecure Files/` for generator scripts
...
Read $RED_RUN_DOCS/PayloadsAllTheThings/Upload Insecure Files/Configuration Apache .htaccess/
Read $RED_RUN_DOCS/PayloadsAllTheThings/Upload Insecure Files/Configuration IIS web.config/
