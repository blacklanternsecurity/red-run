...
See `~/docs/PayloadsAllTheThings/Upload Insecure Files/` for generator scripts
...
Read ~/docs/PayloadsAllTheThings/Upload Insecure Files/Configuration Apache .htaccess/
Read ~/docs/PayloadsAllTheThings/Upload Insecure Files/Configuration IIS web.config/
