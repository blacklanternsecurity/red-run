...
```bash
git clone https://github.com/security-research/public-security-references ~/docs/public-security-references
git clone https://github.com/security-research/public-security-references ~/docs/public-security-references
git clone https://github.com/public-security-references-wiki/public-security-references ~/docs/public-security-references
```
