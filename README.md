...
These skills are a **baseline** built from three public source repositories (PayloadsAllTheThings, InternalAllTheThings, HackTricks). They cover the most common techniques with the top 2-3 payloads per variant.
