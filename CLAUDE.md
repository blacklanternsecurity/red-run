...
git clone https://github.com/swisskyrepo/InternalAllTheThings "$RED_RUN_DOCS/InternalAllTheThings"
git clone https://github.com/swisskyrepo/PayloadsAllTheThings "$RED_RUN_DOCS/PayloadsAllTheThings"
git clone https://github.com/HackTricks-wiki/hacktricks "$RED_RUN_DOCS/hacktricks"
```
