...
git clone https://github.com/security-research/public-security-references "$RED_RUN_DOCS/public-security-references"
git clone https://github.com/security-research/public-security-references "$RED_RUN_DOCS/public-security-references"
git clone https://github.com/public-security-references-wiki/public-security-references "$RED_RUN_DOCS/public-security-references"
```
