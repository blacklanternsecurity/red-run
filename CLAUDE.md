...
| Repo | Path | Strength |
|------|------|----------|
| InternalAllTheThings | `~/docs/InternalAllTheThings` | AD, red team ops, cloud, evasion |
| PayloadsAllTheThings | `~/docs/PayloadsAllTheThings` | Web payloads, injection techniques |
| HackTricks | `~/docs/hacktricks` | Broadest scope, binary exploitation, macOS, mobile, network protocols |
