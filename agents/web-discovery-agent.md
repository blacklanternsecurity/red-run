...
**Phase grouping for web discovery:**
- Technology fingerprinting + content discovery (ffuf, httpx) = one phase
- Parameter discovery + input mapping = one phase
- Injection testing (active probing of discovered inputs) = one phase
