...
**Phase grouping for Windows privesc:**
- Host enumeration (system info, users, privileges, services) = one phase
- Privilege escalation attempt (token impersonation, service abuse, UAC bypass)
  = one phase
